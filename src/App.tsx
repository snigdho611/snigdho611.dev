        ...
        <div className="main_hero" ref={heroRef}>
          <div className="main_hero_container" ref={aboutRef}>
            ...
            <span className="main_hero_container_content">
              A Full Stack <strong>Software Engineer</strong> with 2+ years experience. Versatile in
              both <strong>Frontend </strong> and <strong>Backend </strong> technologies.
            </span>
            <span className="main_hero_container_content">
              My set of skills is versatile and is continuously expanding.
            </span>
            <a href={"https://www.github.com/snigdho611"} className="main_hero_container_checkout">
              Check Out My Work
            </a>
          </div>
        </div>
                ...
                return (
                  <div
                    ...
                    className={`main_experience_body_companies_company ${
                      activeExperience === i ? "main_experience_body_companies_company-active" : ""
                    }`}
                  >
                    {company}
                  </div>
        ...
        <div className="main_contact" ref={contactRef}>
          ...
          <div className="main_contact_content">
            <div className="main_contact_content_description">
              If you would like to get in touch for any types of query, please opt for any of the
              means below:
            </div>
